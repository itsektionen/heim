...
Vi är Sektionen för Informationsteknik, en av de största sektionerna under <a href="https://thskth.se" target="_blank" rel="noopener noreferrer">Tekniska Högskolans Studentkår (THS)</a> vid <a href="https://kth.se" target="_blank">KTH</a> i Stockholm.
...
Sektionen består av en styrelse och flertalet nämnder som ansvarar för olika aspekter av sektionens verksamhet. Dessutom har sektionen en stark representation både i skolledningen och hos THS centralt. En lista över alla nämnder inom sektionen finns tillgänglig under [sektionsnämnder](/committees). Du kan även hitta en lista över alla [förtroendevalda medlemmar](/trustees).
...
Du blir medlem i sektionen genom att gå med i <a href="https://thskth.se/sv/medlemskap" target="_blank">Tekniska Högskolans Studentkår (THS)</a>. Som medlem har du lättare att ta del av alla våra aktiviteter och förmåner. Dessutom får du även ködagar hos Stockholms Studentbostäder.
...
Den digitala sångboken hittar du på <a href="https://sangbok.kth.it" target="_blank">sangbok.kth.it</a>.

_Vill du bidra till låtarna i sångboken så kan du göra en Pull Request med ändringarna på sektionens GitHub <a href="https://github.com/itsektionen/songlist" target="_blank">songlist repository</a>.
Vill du hjälpa till att utveckla webappen så hittar du även den koden i <a href="https://github.com/itsektionen/songbook-2.0" target="_blank">songbook-2.0 repository</a> som också finns på sektionens GitHub.
Håll även utkik för en ny fysisk utgåva är på gång, för första gången på över 10 år!_
